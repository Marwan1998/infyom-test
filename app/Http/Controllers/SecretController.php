...
use App\DataTables\SecretDataTable;
...
class SecretController extends AppBaseController
{
     ...
     *
     * @param SecretDataTable $secretDataTable
     *
     * @return Response
     */
    public function index(SecretDataTable $secretDataTable)
    {
        return $secretDataTable->render('secrets.index');
    }
